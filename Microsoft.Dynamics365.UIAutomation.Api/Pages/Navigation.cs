...
namespace Microsoft.Dynamics365.UIAutomation.Api
{
        ...
        : XrmPage
    {
        ...
        public BrowserCommandResult<bool> OpenSubAreabyID(string subArea, int thinkTime = Constants.DefaultThinkTime)
        {
            Browser.ThinkTime(thinkTime);

            return this.Execute(GetOptions($": {subArea}"), driver =>
            {
                driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='Training'])[1]/following::img[2]")).Click();
                driver.FindElement(By.Id(subArea)).Click();
                SwitchToContent();
                driver.WaitForPageToLoad();
