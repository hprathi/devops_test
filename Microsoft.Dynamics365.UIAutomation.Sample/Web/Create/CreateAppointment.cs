...
namespace Microsoft.Dynamics365.UIAutomation.Sample.Web
{
    ...
    public class CreateAppointment
    {
        ...
        [TestMethod]
        public void WEBTestCreateNewAppointment()
        {
            using (var xrmBrowser = new Api.Browser(TestSettings.Options))
            {
                ...
                //xrmBrowser.Grid.SwitchView("All Appointments");

                //xrmBrowser.ThinkTime(1000);
                xrmBrowser.CommandBar.ClickCommand("APPOINTMENT");

                xrmBrowser.ThinkTime(5000);
                xrmBrowser.Entity.SetValue("subject", "Add Appointment");
                xrmBrowser.Entity.SelectLookup("requiredattendees", 0);
